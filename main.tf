...
locals {
  ...
  labels = {
    "app.kubernetes.io/name"       = "azure-health-exporter"
  ...
  spec {
    ...
    template {
      ...
      spec {
        ...
        container {
          name              = "azure-health-exporter"
          image             = "fxinnovation/azure-health-exporter:${local.application_version}"
          image_pull_policy = var.image_pull_policy

          volume_mount {
            name       = "configuration-volume"
            mount_path = "/opt/azure-health-exporter/config"
          }
