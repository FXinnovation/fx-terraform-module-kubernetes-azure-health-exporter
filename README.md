# terraform-module-kubernetes-azure-health-exporter
Terraform module for azure-health-exporter
...
| client\_id | Client ID that will be used by the azure-health-exporter. | `string` | n/a | yes |
| client\_secret | Client secret that will be used by the azure-health-exporter. | `string` | n/a | yes |
...
| config\_map\_name | Name of the config map that will be created. | `string` | `"azure-health-exporter"` | no |
| configuration | Configuration to use for azure-health-exporter (must be a map). | `map` | `{}` | no |
...
| deployment\_name | Name of the deployment that will be create. | `string` | `"azure-health-exporter"` | no |
...
| secret\_name | Name of the secret that will be created. | `string` | `"azure-health-exporter"` | no |
...
| service\_name | Name of the service that will be create | `string` | `"azure-health-exporter"` | no |
| subscription\_id | Subscription ID that will be used by the azure-health-exporter. | `string` | n/a | yes |
| tenant\_id | Tenant ID that will be used by the azure-health-exporter. | `string` | n/a | yes |
